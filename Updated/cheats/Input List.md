...
PAD 1 - Wanted Level + Up	== LRLRLR [Left, Right, (repeated)]
PAD 1 - Wanted Level - Down	== UDUDUD [Up, Down, (repeated])

PAD 2 - HUD TOGGLE 			== START
PAD 2 - Cam Pos & Teleport  == CIRCLE  / R2 	|| (CAMERA POSITIION = CIRCLE) && (TELEPORT = R2) (to spawn at cam position)

PAD 2 - mem stats pages		== L1 + L2 + R1 + R2 || Use Debug Menu to show/ hide specific stats.
PAD 2 - show player pos 	== X, Triangle, Square, Cirlce, & R2 	|| Shows coords/ player position && mem

---- Debug Mode (ON OR OFF) ----
PAD 2 - Triangle 			== Toggle: debug Mode
PAD 2 - DOWN 				== weapons
PAD 2 - LEFT/RIGHT			== MISSION NUMS UP/DOWN
...
[Freeze (Toggle)] && [extra cheats]		|| 
Press & Hold [PAD 1 - L1, L2] && [PAD 2 - X] && then press [PAD 1 - R3]
* toggle free player pos on, off.
* && extra cheats;-
