...
//--------------------------------------------------------------------------------------------------------------------
//---- GTA Vice City PS2 In-Game Glitches ----
//--------------------------------------------------------------------------------------------------------------------

---- GTA Vice City Glitches ----

//[Vigilante + Save icon Glitch]
//* a method of duplicating mission events e.g: vehicle spawns, to obtain those vehicles. It exploits values relating to current mission number and mission status.
//* this process is entirely pointeless except for the "Ice-Cream Factory bullet proof tyres glitch" discovered by TKBS.

//[Bullet proof tyres Ice-Cream Factory Glitch (ICF-Glitch)]
...
Not working ??? Police Zombies:       	

[Super Stoppie Trick (Faggio)]

* gain a good amount of speed.
* perform stoppie:  // this was online uncredited
 - ← analog stick ↑ & hold ◻ & R1)
 - release ◻ & R1 then hold ↓ X.
 // wheelies are easier travelling south, not north.
 // the handling.cfg can be modified - e.g bfinject car is different depending on release version, 
